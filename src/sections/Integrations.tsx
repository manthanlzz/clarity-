        ...
        <section className="py-24 overflow-hidden">
            <div className="container">
                ...
                <h2 className="text-6xl font-medium mt-6">
                    Plays well with <span className="text-[#D3D3D3]">others</span>
                </h2>
                <p className="text-white/50 mt-4 text-lg">
                    Clarity seamlessly connects with your favorite tools, enhancing
                    your workflow and enabling collaboration across platforms.
                </p>
                </div>
                <div>
                <div className="h-[400px] lg:h-[800px] mt-8 lg:mt-0 overflow-hidden grid md:grid-cols-2 gap-4 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
                 <IntegrationColumns integrations={integrations} />
                   <IntegrationColumns integrations={integrations.slice().reverse()}
                    reverse
